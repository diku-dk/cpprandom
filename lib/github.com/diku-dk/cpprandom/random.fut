...
module minstd_rand : rng_engine with int.t = u32 = linear_congruential_engine u32 {
  def a = 48271u32
  def c = 0u32
  def m = 2147483647u32
}
...
-- `m=2147483647`.  This is the same configuration as in C++.
module minstd_rand0 : rng_engine with int.t = u32 = linear_congruential_engine u32 {
  def a = 16807u32
  def c = 0u32
  def m = 2147483647u32
}
...
-- `w=24`, `s=10`, `r=24`.
module ranlux24_base : rng_engine with int.t = u32 = subtract_with_carry_engine u32 {
  def w : i32 = 24
  def s : i32 = 10
  def r : i32 = 24
}
...
-- It is an instantiation of `subtract_with_carry_engine`@term with
-- `w=48`, `s=5`, `r=12`.
module ranlux48_base : rng_engine with int.t = u64 = subtract_with_carry_engine u64 {
  def w : i32 = 48
  def s : i32 = 5
  def r : i32 = 12
}
